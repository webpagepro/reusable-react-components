// DPT- 3643 11/27 - 11/28 @2:30am, 2022 US Black Friday Deals main landing page, lu: 11.22.2022.RR
/*
...
let data_container = [
    {
        ...
        title: "Cyber Deals Start Now!",
        subTitle: "Check back tomorrow for more new deals: Treats members always get more!",
        isInverted: true,
        backgroundColor: "#DD2834",
        mediaInfo: {
            url: {
                imgContent: imagelink("WEB-1491464-Nov22_FB-I_CyberMon-Deals_MO"),
                desktop: {
                    imgContent: imagelink("WEB-1491464-Nov22_FB-I_CyberMon-Deals_DT"),
                }
            },
            alt: "Cyber Deals Start Now!",
    ...
    },
    {
        ...
        tileSections: {
            skuList: "(5304018,5329618,5320220,5298860,5331755,5315113,5311279,5332760,5332906,5332648,5264309,5332753)", // comma without space between skus
        },
    },
    { // Dog & Cat deals - 4card up grid display of promocarddw
        ...
        tileSections: [
            {
                title: "Save up to 50%",
                subTitle: "select JoyHound™ & Top Paw® toys",
                readMoreText: "",
                readMoreLink: "/sale/todays-deals-0026/dog-deals/deal-19/?origin=blackfridaydeals&desc=deal1&type=card4up",
                imgContent: imagelink("WEB-1325352-Nov22_4CRD-1_BF-WE_JOYHOUND_MO"),
                desktop: {
                    imgContent: imagelink("WEB-1325352-Nov22_4CRD-1_BF-WE_JOYHOUND_DT"),
                },
                alt: "JoyHound™ & Top Paw® toys",
            },
            {
                title: "Save 50%",
    ...
    { // CAT DEALS - 3card up grid display of promocard
        ...
        tileSections: [
            ...
            {
                title: "Save 50%",
                subTitle: "all Whisker City® cat toys",
                readMoreText: "",
                readMoreLink: "/sale/todays-deals-0026/cat-deals/deal-9/?origin=todaysdeals&desc=deal3&type=card3up",
                imgContent: imagelink("WEB-1325352-Nov22_3CRD-3_K-FRI_WE_WhiskerCity_MO"),
                desktop: {
                    imgContent: imagelink("WEB-1325352-Nov22_3CRD-3_K-FRI_WE_WhiskerCity_DT"),
                },
                alt: "Whisker City® cat toys",
    ...
    { // Deals starting at 25% OFF - 4card up grid display of promocarddw
        containerName: "featuredTilesGrid",
        title: "Deals starting at 25% OFF",
        subTitle: "",
        showAllText: "",
        showAllLink: "",
        variant: "4up",
        ...
        tileSections: [
            ...
            {
                title: "Save 25%",
                subTitle: "Nate + Jeremiah collection",
                readMoreText: "",
                readMoreLink: "/sale/todays-deals-0026/fish-deals/deal-7/?origin=blackfridaydeals&desc=deal8&type=card4up",
                imgContent: imagelink("WEB-1325352-Nov22_4CRD-4_K-FRI-WE_NJ_MO"),
                desktop: {
                    imgContent: imagelink("WEB-1325352-Nov22_4CRD-4_K-FRI-WE_NJ_DT"),
                },
                alt: "Nate + Jeremiah collection",
            },
        ],
    },
