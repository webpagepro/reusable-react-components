// DPT-4183 - FW4 Loyalty Card - 02.20 - 02.21 - lu: 02.15.2023-RR
let imagelink = (sku) => {
...
let data_container = [
    ...
    {
        containerName: "PromoBanner",
        title: "Tidy Cats® LightWeight Litter - Around-the-clock odor control",
        href: "/featured-brands/tidy-cats/?origin=home&desc=tidycats&type=tertiary2",
        imgContent: imagelink("WEB-1645004-Feb23_HP-PROMO-MB3_TidyCats_MO"),
        desktop: { imgContent: imagelink("WEB-1645004-Feb23_HP-PROMO-MB3_TidyCats_DT") },
        ctaText: "Shop now",
        alt: "Tidy Cats LightWeight Litter - Around-the-clock odor control",
        isInverted: false,
    },
    {
        containerName: "GridDisplay",
