// DPT-3762 - N+J Q&A Update - US - lu: 11.03.2022-MS
...
let data_container = [
    // Hero banner Large
    {
        ...
        tileSections: {
            ...
            skuList: "(5329622,5329661,5329639,5330373,5330986,5329592,5329659)", // comma without space between skus
        ...
        tileSections: [
            {
                ...
                link: "/featured-brands/nate-and-jeremiah/fish-collection/?origin=brandshop&desc=n+j&type=card6up1"
            ...
            },
            {
                ...
                link: "/featured-brands/nate-and-jeremiah/reptile-collection/?origin=brandshop&desc=n+j&type=card6up2"
            },
            {
                imgContent: imagelink("WEB-1413553-Sept22_3CARD_NJ-SP-SmPet_DT"),
                alt: "Small pet iconography.",
                title: "Small pet collection",
                link: "/featured-brands/nate-and-jeremiah/small-pet-collection/?origin=brandshop&desc=n+j&type=card6up3"
            },
    ...
    // Featured Media
    {
        ...
        isInverted: false,
        mediaInfo: {
            url: "https://www.youtube.com/embed/Uafjs_jhCWM?origin=brandshop&desc=n+j&type=feature",
    ...
    {//1-3 up grid display of promocard
        ...
        showAllLink: "/featured-brands/nate-and-jeremiah/?origin=brandshop&desc=n+j&type=card3up",
        variant: "1-3up",
        textAlign: "left",
        tileSections: [
            {
                ...
                readMoreText: "",
                readMoreLink: "/featured-brands/nate-and-jeremiah/fish-collection/?origin=brandshop&desc=n+j&type=card3up1",
...

            {
                ...
                readMoreText: "",
                readMoreLink: "/featured-brands/nate-and-jeremiah/reptile-collection/?origin=brandshop&desc=n+j&type=card3up2",
...

            {
                ...
                readMoreText: "",
                readMoreLink: "/featured-brands/nate-and-jeremiah/small-pet-collection/?origin=brandshop&desc=n+j&type=card3up3",
            ...
            //Tab- 1 starts here
            {
                ...
                sections: [
                    { // StoryTelling Carousel  (API CALL)
                        ...
                        title: "Stands",
                        shopLink: "/featured-brands/nate-and-jeremiah/fish-collection/stands/?origin=brandshop&desc=n+j&type=productcarousel​",
                        ctaText: "Shop all",
                        shouldCallApi: true,
                        tileSections: {
                            ...
                            skuList: "(5329615,5329616,5329617,5329618,5329619,5329620,5329621,5329622,5329623)", // comma without space between skus
                        },
                    ...
                    { // StoryTelling Carousel  (API CALL)
                        containerName: "ExclusiveOffer",
                        title: "Décor",
                        shopLink: "/featured-brands/nate-and-jeremiah/fish-collection/decor/?origin=brandshop&desc=n+j&type=productcarousel​",
                        ctaText: "Shop all",
                        shouldCallApi: true,
                        tileSections: {
                            promoCard: { // promo card
                            ...
                            skuList: "(5329638,5329524,5329522,5329639,5329637,5329636,5329659,5329592,5330372,5330986,5330987,5330985,5329635)", // comma without space between skus
                        },
                    ...
                    { // StoryTelling Carousel  (API CALL)
                        ...
                        shopLink: "/featured-brands/nate-and-jeremiah/fish-collection/artificial-plants/?origin=brandshop&desc=n+j&type=productcarousel​",
                        ctaText: "Shop all",
                        shouldCallApi: true,
                        tileSections: {
                            promoCard: { // promo card
            ...
            //Tab- 2 starts here
            {
                ...
                sections: [
                    { // StoryTelling Carousel  (API CALL)
                        containerName: "ExclusiveOffer",
                        title: "Stands",
                        shopLink: "/featured-brands/nate-and-jeremiah/reptile-collection/stands/?origin=brandshop&desc=n+j&type=productcarousel​​",
                        ctaText: "Shop all",
                        shouldCallApi: true,
                        tileSections: {
                            promoCard: { // promo card
                    ...
                    { // StoryTelling Carousel  (API CALL)
                        containerName: "ExclusiveOffer",
                        title: "Décor",
                        shopLink: "/featured-brands/nate-and-jeremiah/reptile-collection/decor/?origin=brandshop&desc=n+j&type=productcarousel​​",
                        ctaText: "Shop all",
                        shouldCallApi: true,
                        tileSections: {
                            promoCard: { // promo card
                            ...
                            skuList: "(5329519,5329664,5329663,5329640,5329656,5329655,5329661,5330799,5329593)", // comma without space between skus
                        },
                    ...
                    { // StoryTelling Carousel  (API CALL)
                        containerName: "ExclusiveOffer",
                        title: "Hides",
                        shopLink: "/featured-brands/nate-and-jeremiah/reptile-collection/hides/?origin=brandshop&desc=n+j&type=productcarousel​​​",
                        ctaText: "Shop all",
                        shouldCallApi: true,
                        itemsPerView: 3,
                        displaySettings: {
            ...
            //Tab- 3 starts here
            {
                ...
                sections: [
                    { // StoryTelling Carousel  (API CALL)
                        containerName: "ExclusiveOffer",
                        title: "Stands",
                        shopLink: "/featured-brands/nate-and-jeremiah/small-pet-collection/stands/?origin=brandshop&desc=n+j&type=productcarousel​​​",
                        ctaText: "Shop all",
                        shouldCallApi: true,
                        tileSections: {
                            promoCard: { // promo card
                    ...
                    { // StoryTelling Carousel  (API CALL)
                        containerName: "ExclusiveOffer",
                        title: "Décor",
                        shopLink: "/featured-brands/nate-and-jeremiah/small-pet-collection/decor/?origin=brandshop&desc=n+j&type=productcarousel​",
                        ctaText: "Shop all",
                        shouldCallApi: true,
                        tileSections: {
                            promoCard: { // promo card
                            ...
                            skuList: "(5329519,5329664,5329663,5329640,5329644,5329652,5329643,5329648,5329785,5330956)", // comma without space between skus
                        },
                    ...
                    { // StoryTelling Carousel  (API CALL)
                        containerName: "ExclusiveOffer",
                        title: "Accessories",
                        shopLink: "/featured-brands/nate-and-jeremiah/small-pet-collection/accessories/?origin=brandshop&desc=n+j&type=productcarousel​​​​",
                        ctaText: "Shop all",
                        shouldCallApi: true,
                        tileSections: {
                            promoCard: { // promo card
                            ...
                            skuList: "(5329666,5329665,5329641,5329642,5329591,5329651)", // comma without space between skus
                        },
