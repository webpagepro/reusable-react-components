// DPT-4250 CA Treat Member Month Landing Page - 04.07 - 04.10 - lu: 03.23.2023-JC
let imagelink = (sku) => {
...
let data_container = [
...

   {
        ...
        tileSections: [
            {
                title: "Weekend only! 10X points on entire purchase",
            ...
            },
            {
                ...
                tileSections: {
                    ...
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/top-fin/?pmin=0.01&prefn1=customCategory&prefv1=Ornaments&srule=best-sellers?origin=TreatsMembersMonth&type=offercarddrawer&desc=top-fin",
                    skuList: "(5013323,5261818,5123133,5254517,5018180,5276243,5276535,5088205,1833162,5123124,1833871,5109973,5276348,5291963,5088199,5254636,5071396,5009361)",
                }
            },
            {
                ...
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/full-cheeks/?pmin=0.01&prefn1=customCategory&prefv1=Hay%7CBedding?origin=TreatsMembersMonth&type=offercarddrawer&desc=full-cheeks",
                    skuList: "(5319251,5318774,5319248,5319159,5319060,5319247,5318343,5328814,5319157,5319367,5318527,5319249,5319365,5319250,5318341,5319162,5318526,5318344)",
                }
            },
            {
                ...
                tileSections: {
                    ...
                    skuList: "(5298983,5308136,5298972,5308921,5298839,5298837,5308138,5298960,5299035,5298703,5298939,5308139,5298993,5298937,5298984,5298842,5298945,5298838)",
                }
            },
        ],
    },
    ...
    },
    {
        ...
        tileSections: {
            skuList: "(5331995,5318774,5298972,5331990,5319365,5298959,5331862,5328814,5308138,5331863,5328955,5308136,5331943,5319251,5298939,5331887,5319159)", // comma without space between skus
        },
    },
    {
        containerName: "PromoBanner",
