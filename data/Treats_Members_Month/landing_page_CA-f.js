// DPT-4266 CA Treat Member Month Landing Page Week 3 weekend offer - 04.21 - 04.23 - lu: 04.07.2023-JenR
let imagelink = (sku) => {
...
let data_container = [
...

   {
        ...
        tileSections: [
            {
                title: "Weekend only! Earn 5X pts on any purchase",
                desc: "It’s April Treats Members Month! This weekend only, activate this offer and earn 5X Treats points on any in-store or online purchase through 4/23/23.",
                imgContent: imagelink("WEB-1722652-Apr23_OCD1_Treats-WK2_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD1_Treats-WK2_DT"),
                },
                alt: "Weekend only! Earn 5X pts on any purchase",
                // badges: [
