// DPT-4210 US Treats Members Month Landing Week 1 - 04.07 - 04.10 - lu: 03.30.2023-RR
let imagelink = (sku) => {
...
let data_container = [
  /* {
...

   {
        ...
        desc:"Activate & shop special deals online & in stores this week only thru 4/9",
        displayLink: true,
        optionalText: true,
        truncateLines: 0,
        linkLabel: "",
        ...
        tileSections: [
            {
                title: "Weekend only! 10X points in stores & online",
                ...
                imgContent: imagelink("WEB-1722652-Apr23_OCD5_Treats-WK1_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD5_Treats-WK1_DT"),
                },
                alt: "",
                ...
                // ],
                offerExp: "Valid 4/7-4/9, terms apply",
                offerId: "C2310LPNMMBIG10XD", //
                hasCarousel: false,
            },
            {
                title: "5X points on Hill's Science Diet dog & cat food",
                ...
                imgContent: imagelink("WEB-1722652-Apr23_OCD1_Treats-WK1_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD1_Treats-WK1_DT"),
                },
                alt: "5X points on Hill's Science Diet dog & cat food",
                // badges: [
                //     { title: "Badge", size: "sm", variant: "primary" },
                //     // {title:"Urgent care", size:"sm", variant:"primary"}
                // ],
                offerExp: "Valid thru 4/9, terms apply",
                offerId: "C2309LPNHILLSCI5XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/hills-science-diet/dog/?origin=TreatsMembersMonth&type=offercarddrawer&desc=hills",
                    skuList: "(5154856,5154810,5286296,5209028,5266809,5237395,5246994,5246501,5242067,5154809,5286297,5253228,5266810,5081259,5210069,5253229,5266808,5298793)",
                }
            },
            {
                title: "3X points on Top Fin aquatic ornaments",
                ...
                imgContent: imagelink("WEB-1722652-Apr23_OCD2_Treats-WK1_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD2_Treats-WK1_DT"),
                },
                alt: "3X points on Top Fin aquatic ornaments",
                offerExp: "Valid thru 4/9, terms apply",
                offerId: "C2309LPNTOPF3XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/top-fin/?origin=TreatsMembersMonth&type=offercarddrawer&desc=top-fin",
                    skuList: "(5331995,5331990,5331862,5331863,5331943,5331887,5331889,5331891,5330261,5332066,5123133,5013323,5261818,1833871,5018180,5254517,5276535,5071396)",
                }
            },
            {
                title: "3X points on Full Cheeks hay & bedding",
                ...
                imgContent: imagelink("WEB-1722652-Apr23_OCD3_Treats-WK1_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD3_Treats-WK1_DT"),
                },
                alt: "3X points on Full Cheeks hay & bedding",
                offerExp: "Valid thru 4/9, terms apply",
                offerId: "C2309LPNFCHHB3XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/full-cheeks/?origin=TreatsMembersMonth&type=offercarddrawer&desc=full-cheeks",
                    skuList: "(5318774,5319365,5328814,5328955,5319251,5319159,5318527,5319060,5319248,5318531,5318343,5319157,5318341,5318455,5319163,5318530,5319162,5319356)",
                }
            },
            {
                title: "3X points on Tiki Cat food",
                ...
                imgContent: imagelink("WEB-1722652-Apr23_OCD4_Treats-WK1_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD4_Treats-WK1_DT"),
                },
                alt: "3X points on Tiki Cat food",
                offerExp: "Valid thru 4/9, terms apply",
                offerId: "C2309LPNTIKIC3XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/tiki-cat/?origin=TreatsMembersMonth&type=offercarddrawer&desc=tiki-cat",
                    skuList: "(5298972,5298959,5308138,5308136,5298939,5308921,5322943,5298945,5309105,5298837,5298984,5322833,5298838,5298952,5298842,5298839,5298993,5298937)",
                }
            },
        ],
    },
    ...
    },
    {
        ...
        tileSections: {
            skuList: "(5154856,5331995,5318774,5298972,5154810,5331990,5319365,5286296,5298959,5331862,5209028,5328814,5308138,5331863,5328955,5266809,5308136,5331943)", // comma without space between skus
        },
    },
    {
        containerName: "PromoBanner",
