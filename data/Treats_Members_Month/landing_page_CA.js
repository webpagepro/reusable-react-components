// DPT-4482 Injection of week 4 of DPT-4267 CA Treat Member Month Landing Page Week 4 offer - 04.24 - 04.30 - lu: 04.27.2023-JC
let imagelink = (sku) => {
...
let data_container = [
...

   {
        ...
        tileSections: [
            {
                ...
                desc: "It’s April Treats Members Month! This week only, activate this offer and double your redemption. Redeem up to 20,000 points (worth $50 in savings) 4/24-4/30 and we’ll give ’em back. Redeem them again 5/5-5/21 (or they disappear).",
            ...
            },
            {
                ...
                desc: "It’s April Treats Members Month and we’re celebrating with great deals each week. Activate this offer and earn 3X Treats points on All Living Things through 4/30/23.",
                ...
                tileSections: {
                    ...
                    skuList: "(5290113,5300941,5290308,5300939,5291007,5300937,5291010,5311279,5291011,5300921,5291008,5300923,5301443,5142324,5262727,5301106,5151088,5300940)",
                }
            },
            {
                title: "5X points on Wellness dog & cat food & treats",
                desc: "It’s April Treats Members Month and we’re celebrating with great deals each week. Activate this offer and earn 5X Treats points on Wellness dog and cat food and treats through 4/30/23.",
                imgContent: imagelink("WEB-1722652-Apr23_OCD4_Treats-WK4_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD4_Treats-WK4_DT"),
                },
                alt: "5X points on Wellness dog & cat food & treats",
                offerExp: "Valid 4/24-4/30, terms apply",
                offerId: "C2313LPNCANWELL5XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/wellness/?origin=TreatsMembersMonth&type=offercarddrawer&desc=wellness",
                    skuList: "(5163375,5322804,5153512,5153720,5264829,5153508,5249047,5163312,5153537,5249052,5153469,5322304,5163313,5163314,5249049,5322303,5263644,5322807)",
                }
            },
            {
                title: "5X points on Whimzees dog treats & chews",
                desc: "It’s April Treats Members Month and we’re celebrating with great deals each week. Activate this offer and earn 5X Treats points on Whimzees dog treats and chews through 4/30/23.",
                imgContent: imagelink("WEB-1722652-Apr23_OCD5_Treats-WK4_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD5_Treats-WK4_DT"),
                },
                alt: "5X points on Whimzees dog treats & chews",
                offerExp: "Valid 4/24-4/30, terms apply",
                offerId: "C2313LPNCANWHIM5XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/whimzees/?origin=TreatsMembersMonth&type=offercarddrawer&desc=whimzees",
                    skuList: "(5306142,5306141,5306140,5275557,5275547,5275553,5221681,5255078,5308702,5221679,5322517,5308703,5289879,5275556,5239335,5275549,5287577,5275560)",
                }
            },
        ],
    },
    ...
    },
    {
        ...
        tileSections: {
            skuList: "(5290113,5163375,5306142,5300941,5322804,5306141,5290308,5153512,5306140,5300939,5153720,5275557,5291007,5264829,5275547,5300937,5153508,5275553)", // comma without space between skus
        },
    },
    {
        containerName: "PromoBanner",
