// DPT-4408 CA Treat Member Month Landing Page Week 2 INJECTION - 04.14 - 04.16 - lu: 04.14.2023-RR
let imagelink = (sku) => {
...
let data_container = [
...

   {
        ...
        desc:"Activate & shop special deals online & in stores this week only thru 4/16",
        displayLink: true,
        optionalText: true,
        truncateLines: 0,
        linkLabel: "",
        ...
        tileSections: [
            {
                title: "Weekend only! 4K pts on $50+ in stores or online",
                desc: "It’s April Treats Members Month! This weekend only, activate this offer and earn 4,000 Treats points (worth $10 in savings) when you spend $50+ online through 4/16/23.",
                imgContent: imagelink("WEB-1722652-Apr23_OCD5_Treats-WK2_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD5_Treats-WK2_DT"),
                },
                alt: "Weekend only! 4K pts on $50+ in stores or online",
                // badges: [
                //     { title: "Badge", size: "sm", variant: "primary" },
                //     // {title:"Urgent care", size:"sm", variant:"primary"}
                // ],
                offerExp: "Valid 4/14-4/16, terms apply",
                offerId: "C2311LPNMMBIG24KD", //
                hasCarousel: false,
            },
            {
                title: "5X points on select flea & tick products",
                desc: "It’s April Treats Members Month and we’re celebrating with great deals each week. Activate this offer and earn 5X Treats points on Seresto®, K9 Advantix® II Dog and Advantage® Cat through 4/16/23.",
                imgContent: imagelink("WEB-1722652-Apr23_OCD1_Treats-WK2_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD1_Treats-WK2_DT"),
                },
                alt: "5X points on select flea & tick products",
                // badges: [
                //     { title: "Badge", size: "sm", variant: "primary" },
                //     // {title:"Urgent care", size:"sm", variant:"primary"}
                // ],
                offerExp: "Valid 4/10-4/16, terms apply",
                offerId: "C2310LPNMMDFT5XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/flea-and-tick.html?origin=TreatsMembersMonth&type=offercarddrawer&desc=flea-and-tick",
                    skuList: "(5192440,5214367,5214339,5192438,5214373,5214340,5191472,5214341,5214342,5214338,5218515,5285872,5214335,5214343,5214371,5214304,5214336,5214344)",
                }
            },
            {
                title: "6X points on Simply Nourish food & treats",
                desc: "It’s April Treats Members Month and we’re celebrating with great deals each week. Activate this offer and earn 6X Treats points on Simply Nourish® dog and cat food and treats through 4/16/23.",
                imgContent: imagelink("WEB-1722652-Apr23_OCD2_Treats-WK2_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD2_Treats-WK2_DT"),
                },
                alt: "6X points on Simply Nourish food & treats",
                offerExp: "Valid 4/10-4/16, terms apply",
                offerId: "C2311LPNSNDC6XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/simply-nourish/?origin=TreatsMembersMonth&type=offercarddrawer&desc=simply-nourish",
                    skuList: "(5286960,5287616,5286374,5286748,5287292,5286923,5297667,5286753,5287507,5286924,5286465,5286928,5319719,5286749,5286659,5286915,5287520,5286752)",
                }
            },
            {
                title: "6X points on Authority dog & cat food & treats",
                desc: "It’s April Treats Members Month and we’re celebrating with great deals each week. Activate this offer and earn 3X Treats points on Tiki Cat food through 4/9/23.",
                imgContent: imagelink("WEB-1722652-Apr23_OCD3_Treats-WK2_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD3_Treats-WK2_DT"),
                },
                alt: "6X points on Authority dog & cat food & treats",
                offerExp: "Valid 4/10-4/16, terms apply",
                offerId: "C2311LPNAUTDC6XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/featured-brands/authority/?origin=TreatsMembersMonth&type=offercarddrawer&desc=authority",
                    skuList: "(5279157,5279240,5278696,5309039,5309276,5309312,5281765,5278964,5279202,5278732,5309002,5279239,5278693,5279242,5278697,5278735,5309278,5278738)",
                }
            },
            {
                title: "10X points on the Nate + Jeremiah Collection",
                desc: "It’s April Treats Members Month and we’re celebrating with great deals each week. Activate this offer and earn 10X Treats points on the Nate + Jeremiah Collection through 4/16/23.",
                imgContent: imagelink("WEB-1722652-Apr23_OCD4_Treats-WK2_DT"),
                desktop: {
                    imgContent: imagelink("WEB-1722652-Apr23_OCD4_Treats-WK2_DT"),
                },
                alt: "10X points on the Nate + Jeremiah Collection",
                offerExp: "Valid 4/10-4/16, terms apply",
                offerId: "C2311LPNNJ10XD", //
                hasCarousel: true,
                displaySettings: { desktop: 3, tablet: 2.5, mobile: 2.5 },
                tileSections: {
                    title: "Eligible products",
                    ctaText: "Shop all",
                    shopLink: "/nate-and-jeremiah.html?origin=TreatsMembersMonth&type=offercarddrawer&desc=nate-and-jeremiah",
                    skuList: "(5329618,5329785,5329617,5329622,5329615,5329620,5329657,5329635,5329623,5329619,5329593,5329652,5329656,5329655,5329648,5329664,5329621,5329523)",
                }
            },
        ],
    },
    ...
    },
    {
        ...
        tileSections: {
            skuList: "(5295440,5286975,5309276,5329618,5295442,5286924,5279240,5329615,5300579,5285989,5281000,5329620,5300030,5286960,5279218,5329635,5295460,5287616)", // comma without space between skus
        },
    },
    {
        containerName: "PromoBanner",
