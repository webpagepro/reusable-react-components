// DPT-3969 - Holiday 2022 Shop - 12.12 - 12.17 - lu: 12.9.2022-LJ
...
let dataContainer = [
    {
        ...
        title: "SAVE 30%",
        subTitle: "on holiday merchandise thru 12/16, terms & exclusions apply†",
        imgContent: imagelink("WEB-1635653-Dec22_PROMO-LB_CodeRed_Holiday-Promo_MO"),
        desktop: {
            imgContent: imagelink("WEB-1635653-Dec22_PROMO-LB_CodeRed_Holiday-Promo-30_DT"),
        },
        alt: "SAVE 30% on holiday merchandise thru 12/16, terms & exclusions apply†",
        isInverted: true,
    },
    { // Shop by pet
